#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To sajidhacker
...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-gullabijanan-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................sajid khan......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   gullabi
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
...
░█▄▄█ ░█─░█ ░█──▀█ ░█▄▄█
 ...
 \033[1;96m 
  \033[1;96
   \033[1;92m███████▒▒Welcome To FIGHTER GANG▒▒🅢 🅐 🅙 🅘 🅓
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mgullabi\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91msajidehacker
\033[1;94mgullabijanan\033[1;91m: \033[1;91▒🅢 🅐 🅙 🅘 🅓▓]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91msajid khan
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+971544145675
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mgullabi\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................FIGHTER GANG.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin gullabi\033[1;95m♡╰──────────•◈•──────────╯♡"
...
loop = 'true'
while (loop == 'true'):
    username = sajid_input("\033[1;91m🔐 \x1b[1;91mTool Username \x1b[1;91m»» \x1b[1;93m")
    if (username == CorrectUsername):
    	password = sajid_input("\033[1;94m🔐 \x1b[1;91mTool Password \x1b[1;91m»» \x1b[1;92m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #sajid:by_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print('	' )
		id = sajid_input('\033[1;96m[+] \x1b[1;92mID/Email\x1b[1;95m: \x1b[1;96m')
		pwd = sajid_input('\033[1;96m[+] \x1b[1;93mPassword\x1b[1;96m: \x1b[1;96m')
		tik()
		try:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #sajid:by_hacker
	print logo
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mgullabi\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mgullabi\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Gullabi By love---•◈•---»" #Gullabi:by_hacker
...
♡──────────────•◈•──────────────♡.
: \033[1;96m .....sajidhacker  gullabijanan........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               00971544145675"""
